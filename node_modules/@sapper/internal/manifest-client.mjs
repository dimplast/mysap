...
export const ignore = [/^\/courses\.json$/, /^\/courses\/([^/]+?)\.json$/, /^\/auth\/register\/?$/, /^\/blog\.json$/, /^\/blog\/([^/]+?)\.json$/];
...
export const components = [
	...
	{
		js: () => import("../../../routes/courses/index.svelte")
	},
	{
		js: () => import("../../../routes/courses/[id].svelte")
	},
	{
...
if (typeof window !== 'undefined') {
	import("C:/Users/user1/mysap/node_modules/sapper/sapper-dev-client.js").then(client => {
